...
public class StyleUtils
{
    ...
    static
    {
        ...
        STYLES.put('\u000e', "color: lightgreen");
        STYLES.put('\u0011', "color: darkblue");
        STYLES.put('\u0005', "color: blue");
        STYLES.put('\u0003', "color: cyan");
        STYLES.put('\u0017', "color: aqua");
        STYLES.put('\u0019', "color: yellow");
        STYLES.put('\u0012', "color: kaki");
        STYLES.put('\u0010', "color: brown");
        STYLES.put('\u000f', "color: lightgray");
        STYLES.put('\u0006', "color: gray");
        STYLES.put('\u0008', "color: magenta");
